...
export default function Copiloto({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="copilot-mask" onClick={onClose} role="presentation">
      <div className="copilot" onClick={(e) => e.stopPropagation()} role="dialog" aria-label="Copiloto">
        <div className="copilot-in">
          ...
          />
          <span className="badge">{role.label.toUpperCase()}</span>
        </div>
